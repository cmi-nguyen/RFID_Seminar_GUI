...
import App.DTO.DTO_Bill;
import App.DTO.DTO_ProductInstance;
import App.DTO.DTO_ProductLine;
import App.DTO.DTO_TagRead;
...
public class HandleScan {
    ...
    * */
    public App.DTO.DTO_ProductLine FindProductByTag(String Tag){
